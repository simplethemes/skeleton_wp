...
<?php while ( have_posts() ) : the_post(); ?>
	...
	<?php else : ?>
		<div class="entry-content">
			<?php do_action('skeleton_post_thumbnail');?>
			<?php the_content( __( '<br />Continue reading <span class="meta-nav">&rarr;</span>', 'smpl' ) ); ?>
			<div class="clear"></div>
	...
	<?php endif; ?>
		<div class="entry-utility">
			...
			<span class="comments-link">
				<?php comments_popup_link( __( 'Leave a comment', 'smpl' ), __( '1 Comment', 'smpl' ), __( '% Comments', 'smpl' ) ); ?>
			</span>
